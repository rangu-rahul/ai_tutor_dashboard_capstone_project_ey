...
#     dashboard, user_register, user_login, s_home, faculty,
#     faculty_register, faculty_login, StudentViewSet,
#     s_profile, user_logout, faculty_home, faculty_profile,
#     list_students, s_courses, s_course_detail,
#     s_grades, s_assignments, s_attendance,
#     s_study_materials, s_upload_projects,chatbot
# )
...
from django.urls import path, include
from smartaidashboard.views import (
    dashboard, user_register, user_login, s_home,
    faculty, faculty_register, faculty_login,
    s_profile, user_logout, faculty_home,
    faculty_profile, list_students,
    s_courses, s_course_detail,
    s_grades, s_assignments, s_attendance,
    s_grades, s_assignments, s_attendance,
    s_study_materials, s_upload_projects
)

from smartaidashboard.views import StudentViewSet
